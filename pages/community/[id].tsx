  ...
  return (
    <div>
      ...
      <div className="px-4">
        ...
        />
        <button className="mt-2 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium ">
          Reply
        </button>
      </div>
    </div>

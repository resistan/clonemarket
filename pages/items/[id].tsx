        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3 py-3 border-b">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-gray-400">View profile &rarr;</p>
            </div>
          </div>
          <div className="mt-6">
            ...
            <div className="flex items-center justify-between space-x-2">
              <button className="flex-1 bg-orange-500 text-white font-medium py-3 rounded-md hover:bg-orange-600">Talk to seller</button>
